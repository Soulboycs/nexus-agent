...
export interface ReviewContext {
  ...
  setCompareResult: (value: {
    ...
    /** the compared file's parsed blocks — kept for the revision-document export */
    otherBlocks?: Block[]
  } | null) => void
}
...
export async function compareWithFile(ctx: ReviewContext): Promise<void> {
  ...
  try {
    ...
    ctx.setCompareResult({ otherName: other.name, entries, otherBlocks: otherParsed.blocks })
  } catch (err) {
