...
class TabLayoutView {
  ...
  constructor(
    ...
    window.addEventListener('sidebar-resize-end', this.onSidebarResizeEnd)
  ...
  destroy() {
    ...
    window.removeEventListener('sidebar-resize-end', this.onSidebarResizeEnd)
    if (this.resizeTimer) window.clearTimeout(this.resizeTimer)
